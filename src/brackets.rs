...
pub fn get_bracket_type(c: char) -> BracketType {
...
pub fn get_pair_id(c: char) -> Option<u8> {
...
// TODO: Auto-gen from UCD file in tables.rs
...
mod test {
    ...
    #[test]
    fn test_get_bracket_type() {
        assert_eq!(get_bracket_type('a'), BracketType::None);
        assert_eq!(get_bracket_type('('), BracketType::Open);
        assert_eq!(get_bracket_type(')'), BracketType::Close);
        assert_eq!(get_bracket_type('{'), BracketType::Open);
        assert_eq!(get_bracket_type('}'), BracketType::Close);
    }
    ...
    #[test]
    fn test_get_pair_id() {
        assert_eq!(get_pair_id('a'), None);
        assert!(get_pair_id('(').is_some());
        assert!(get_pair_id('(') == get_pair_id(')'));
        assert!(get_pair_id('[') == get_pair_id(']'));
        assert!(get_pair_id('(') != get_pair_id(']'));
    }
}
